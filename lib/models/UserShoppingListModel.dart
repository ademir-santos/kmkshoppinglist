...
class UserShoppingListModel extends AbstractDataBase {

  ///
  /// Singleton
  ///

  static UserShoppingListModel _this;

  factory UserShoppingListModel(){
    if(_this == null){
      _this = UserShoppingListModel.getInstance();
    }
    return _this;
  }

  UserShoppingListModel.getInstance() : super();
