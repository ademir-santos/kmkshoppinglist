...
class HistoricListPage extends StatefulWidget {

  final List<Map> shoppList;

  HistoricListPage({Key key, this.shoppList}): super(key:key);

  static Widget valueWidget;
  static int cont = 0;

  @override
  HistoricListPageState createState() => HistoricListPageState();
}

class HistoricListPageState extends State<HistoricListPage> {
